...
var _freeze_duration_multiplier: float = 1.0
var _split_count_bonus: int = 0
...
func _fire_volley(
	...
	for index: int in range(requested_count):
		...
		context.freeze_duration_multiplier = _freeze_duration_multiplier
		context.split_count_bonus = _split_count_bonus
...
func apply_runtime_modifier(modifier: WeaponRuntimeModifier) -> void:
	...
	_freeze_duration_multiplier *= maxf(modifier.freeze_duration_multiplier, 0.0)
	_split_count_bonus += modifier.split_count_bonus
...
func reset_runtime_state() -> void:
	...
	_freeze_duration_multiplier = 1.0
	_split_count_bonus = 0
...
func get_freeze_duration_multiplier() -> float:
	return _freeze_duration_multiplier


func get_split_count_bonus() -> int:
	return _split_count_bonus
